// Template Typst Profesional para Informes Académicos UPC (ForkDevs)
  ...
  header: context {
    ...
    if page_num > 1 {
      text(size: 8.5pt, fill: rgb("#64748b"))[
        *Universidad Peruana de Ciencias Aplicadas* | Fundamentos de Arquitectura de Software (SI657)
        #h(1fr)
        *ForkDevs*
      ]
      v(-4pt)
...
#set text(
  font: ("Liberation Sans", "DejaVu Sans", "Roboto"),
  size: 10pt,
  lang: "es",
  region: "PE",
  fill: rgb("#1e293b")
