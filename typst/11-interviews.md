...
#table(
  ...
  table.header([*Bloque Temático*], [*Objetivo de Investigación*], [*Artefacto / Módulo Impactado*]),
...
#table(
  ...
  [
    ...
    #v(3pt)
    #text(size: 8.5pt, style: "italic", fill: rgb("#64748b"))[Entrevista 1: Kevin Ramírez Torres]
  ],
  [
    #set text(size: 9.5pt)
    #grid(
  ...
  [
    #block(
      ...
      align(center + horizon)[
        #text(size: 9pt, weight: "bold", fill: rgb("#475569"))[Evidencia Fotográfica] \
        #v(4pt)
        #text(size: 8pt, style: "italic", fill: rgb("#94a3b8"))[(Imagen pendiente de carga)]
      ]
    )
    #v(3pt)
    #text(size: 8.5pt, style: "italic", fill: rgb("#64748b"))[Entrevista 2: Roberto García Sánchez]
  ],
  [
    #set text(size: 9.5pt)
    #grid(
      columns: (100pt, 1fr),
      row-gutter: 0.65em,
      [*Nombres:*], [Roberto García Sánchez],
      [*Segmento Objetivo:*], [Segmento 1: Personal de Gestión y Propietarios (Decisores B2B)],
      [*Cargo / Puesto:*], [Encargado de Mantenimiento y Gestión],
      [*Tipo de Taller:*], [Taller mecánico independiente (MYPE / Pequeña Empresa)],
      [*Personal a Cargo:*], [2 técnicos mecánicos especializados],
      [*Entrevistador:*], [Barrenechea Bustamante, Rafael Andre],
      [*Fecha:*], [07/09/2026],
      [*Tiempo / Video:*], [Pendiente de registro audiovisual]
    )
  ]
)
```
